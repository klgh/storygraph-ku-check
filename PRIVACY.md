...
The extension uses the data described above only to check whether a StoryGraph book is included with Kindle Unlimited:
...
The extension does not use any storage.
...
The extension requests permissions that are necessary for its purpose:

- **Access to websites:** access the StoryGraph book page to check if the book is included with Kindle Unlimited.
