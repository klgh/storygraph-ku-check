...
export type PanelTone = 'idle' | 'checking' | 'available' | 'absent' | 'uncertain' | 'empty' | 'timeout' | 'error';
...
export function paintKuPanel(host: HTMLElement, view: PanelView, onCheck: () => void): void {
